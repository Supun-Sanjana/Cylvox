...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${baseUrl}/trust-signal-auditor/privacy`,
  },
  openGraph: {
    title: "Privacy Policy — Trust Signal Auditor | Cylvox",
    description: "Privacy policy and data collection disclosures for the Trust Signal Auditor WordPress plugin and the optional api.cylvox.com Apply Fix feature.",
    url: `${baseUrl}/trust-signal-auditor/privacy`,
    siteName: "Cylvox",
    type: "website",
    images: [
      {
...
const breadcrumbs = breadcrumbSchema([
  ...
  { name: "Privacy Policy", path: "/trust-signal-auditor/privacy" },
]);
    ...
    <main className="bg-background min-h-screen pt-32 pb-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
              ...
              <table className="w-full text-left text-xs sm:text-sm border-collapse">
                ...
                <tbody className="divide-y divide-border">
                  ...
                  <tr>
                    ...
                    <td className="p-3 sm:p-4">
                      <Link href="/trust-signal-auditor/terms" className="text-foreground underline inline-flex items-center gap-1">
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-wrap items-center justify-between gap-4 text-xs font-semibold">
          <Link href="/trust-signal-auditor/terms" className="text-foreground underline hover:opacity-80">
            View Terms of Service →
          </Link>
          <Link href="/trust-signal-auditor" className="text-muted-foreground hover:text-foreground">
